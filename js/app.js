...
results[5] = new Results('<article>' + '<p>' + "Chitterlings are a popular soul food in the South. The dish consists of the small intestines of a big and cooked in broth - best with an onion to offset the unpleasant smell." + '</p>' + '</article>');
results[6] = new Results('<article>' + '<p>' + "This horrific-looking dish is popular in Scotland. It consists of sheep's offal mixed with oatmeal and boiled in the animal's stomach." + '</p>' + '</article>');
