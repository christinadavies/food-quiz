...
results[5] = new Results('<article>' + '<p>' + "Chitlins are a popular American soul food in the South. The dish consists of the small intestines of a pig and cooked in broth - best with an onion to offset the unpleasant smell." + '</p>' + '</article>');
